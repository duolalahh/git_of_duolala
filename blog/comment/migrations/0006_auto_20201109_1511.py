...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comment', '0005_auto_20200809_1707'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='reply_to',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reqlies', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='comment',
            name='root',
